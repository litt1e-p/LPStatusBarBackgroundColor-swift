Pod::Spec.new do |s|
  s.name             = "LPStatusBarBackgroundColor-swift"
  s.version          = "1.0.0"
  s.summary          = "change UIStatusBar's backgroundColor."
  s.description      = <<-DESC
                       change UIStatusBar backgroundColor dynamically which made via runtime.
                       DESC
  s.homepage         = "https://github.com/litt1e-p/LPStatusBarBackgroundColor-swift"
  # s.screenshots      = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = { :type => 'MIT' }
  s.author           = { "litt1e-p" => "litt1e.p4ul@gmail.com" }
  s.source           = { :git => "https://github.com/litt1e-p/LPStatusBarBackgroundColor-swift.git", :tag => '1.0.0' }
